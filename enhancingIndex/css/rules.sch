...
<!--
   ...
   <!-- <pattern id="physDesc2">
    ...
    <pattern id="origin">
        <rule context="//tei:origin" role="error">
            <assert test="child::tei:origDate"
                >Origin must contain origDate</assert>
        </rule>
        <rule context="//tei:origin" role="warning">
            <assert test="(child::tei:persName or child::tei:orgName or child::tei:placeName)"
